...
<div class="bgimg-1 w3-opacity w3-display-container">
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-xlarge w3-black w3-xlarge w3-wide w3-animate-opacity">BILLS<span class="w3-hide-small"></span> </span>
  </div>
</div>
...
<div class="w3-row w3-padding-32 w3-section">
  ...
  <li class="w3-padding-xlarge w3-center"><a href="receproom.php" style="text-decoration: none">Room Details</a></li>
  	...
  	<div class="w3-col m8 w3-section w3-container">
  ...
  <table class="w3-table-all w3-card-4">
    <tr>
      ...
      <?php 
     $sql="SELECT bill.Billno,customer.CustID,customer.FirstName,customer.LastName,bill.Roomno,bill.Tariff,bill.Servicecharges,reservation.BookingID FROM bill,customer,reservation where bill.CustID=customer.CustID and customer.CustID=reservation.CustID";
    ...
    echo '<td><a href="editbill.php?id=' . $row['Billno'] . '">Edit</a></td>';
